    ...
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Depts
                .GroupJoin(Emps, d => d.Deptno, e => e.Deptno, (d, es) => new { Dept = d, Employees = es })
                .Where(d => d.Employees.Count() > 1)
                .Select(d => new { name = d.Dept.Dname, numOfEmployees = d.Employees.Count() });
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => Emps.Any(sub => sub.Mgr != null && sub.Mgr.Empno == e.Empno))
                .OrderBy(e => e.Ename)
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                .GroupJoin(Emps, d => d.Deptno, e => e.Deptno, (d, es) => new { Dept = d, EmployeeCount = es.Count() })
